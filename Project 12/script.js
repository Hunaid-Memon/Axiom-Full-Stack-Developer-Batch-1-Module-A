...
function render() {
    const renderWord = generateWord();
    word.innerHTML = renderWord;
...
function gameover() {
    ...
    gameoverContainer.innerHTML = `
        <h1>Time up!</h1>
        <p>Good game! your score: ${score} </p>
        <button onclick='location.reload()'>Play again</button>
        `
}

const timeUpdate = setInterval(timeDecrement, 1000)
